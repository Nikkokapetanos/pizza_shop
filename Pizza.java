...
Starting pizza price is $12.00
Toppings cost .50 cents each */

public class Pizza 
{
	// instance variable for the Pizza class
	...
	{
		System.out.println("**********************************");
		System.out.println("Weclome to the Digital Pizza Shop!");
		System.out.println("**********************************");
	} // end of intro() method

	// mutator (setter) methods fro the user class
	public void enterName(String name)
	{
		custName = name;
	} // end of enteName method
